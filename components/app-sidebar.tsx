            ...
            <SidebarMenuButton size="lg" asChild>
              <Link href="/">
                ...
                <div className="grid flex-1 text-left text-sm leading-tight">
                  ...
                  <span className="truncate text-xs text-muted-foreground">Healthcare Referrals</span>
                </div>
              </Link>
            </SidebarMenuButton>
          </SidebarMenuItem>
          ...
          <SidebarMenuItem>
            <SidebarMenuButton asChild>
              <div className="flex items-center gap-2 p-2">
                ...
                <div className="grid flex-1 text-left text-sm leading-tight">
                  <span className="truncate font-semibold">Dr. Sarah Wilson</span>
                  <span className="truncate text-xs text-muted-foreground">Nairobi Hospital</span>
                </div>
              </div>
            </SidebarMenuButton>
          </SidebarMenuItem>
