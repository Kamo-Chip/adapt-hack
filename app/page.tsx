...
import { ArrowRight, Shield, Clock, Users, FileText, Search, CheckCircle, Hospital, Phone, MapPin } from "lucide-react"
    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center space-y-6">
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-balance leading-tight">
              Connect Hospitals, <span className="text-medical-blue">Save Lives</span>
            </h1>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto text-pretty">
              MedRef revolutionizes medical referrals with intelligent hospital matching, real-time capacity tracking,
              and seamless patient transfers across healthcare networks.
            </p>
      ...
      <section className="py-16 px-4 bg-muted/30">
        <div className="container mx-auto max-w-4xl">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            ...
            <div className="space-y-2">
              <div className="text-3xl font-bold text-warning-amber">2.5hrs</div>
      ...
      <section id="features" className="py-20 px-4">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center space-y-4 mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-balance">Everything You Need for Seamless Referrals</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="border-2 hover:border-medical-blue/20 transition-colors">
              <CardHeader>
                ...
                <CardDescription>
                  AI-powered system finds the best hospitals based on capacity, distance, and specialization
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="border-2 hover:border-trust-green/20 transition-colors">
              <CardHeader>
                ...
                <CardDescription>
                  Live updates on hospital bed availability and department capacity across your network
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="border-2 hover:border-warning-amber/20 transition-colors">
              <CardHeader>
                ...
                <CardDescription>
                  Secure upload and sharing of medical records, X-rays, and patient documents
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="border-2 hover:border-medical-blue/20 transition-colors">
              <CardHeader>
                ...
                <CardDescription>
                  Automated WhatsApp notifications keep patients informed throughout the referral process
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="border-2 hover:border-warning-amber/20 transition-colors">
              <CardHeader>
                ...
                <CardDescription>
                  Intelligent urgency classification ensures critical cases receive immediate attention
                </CardDescription>
              </CardHeader>
            </Card>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              <div className="space-y-4">
                <h2 className="text-3xl md:text-4xl font-bold text-balance">Reduce Referral Time by 70%</h2>
                <p className="text-xl text-muted-foreground text-pretty">
                  Transform your referral process from hours to minutes with intelligent automation and real-time
                  coordination.
                </p>
              </div>
              ...
              <div className="space-y-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold mb-1">Instant Hospital Availability</h3>
                    <p className="text-muted-foreground">
                      See real-time bed capacity and department availability across your network
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold mb-1">Automated Documentation</h3>
                    <p className="text-muted-foreground">
                      Digital forms and document sharing eliminate paperwork delays
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold mb-1">Smart Matching Algorithm</h3>
                    <p className="text-muted-foreground">
                      AI finds the optimal hospital based on distance, capacity, and specialization
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-card border rounded-2xl p-8 shadow-lg">
                <div className="space-y-6">
                  <div className="flex items-center justify-between">
                    ...
                    <Badge className="bg-trust-green text-trust-green-foreground">Accepted</Badge>
                  </div>
                  <div className="space-y-4">
                    <div className="flex justify-between">
                      <span className="text-sm">Patient: John Doe</span>
                      <span className="text-sm text-muted-foreground">ID: P-2024-001</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-sm">Department: Cardiology</span>
                      <span className="text-sm text-urgent-red">High Priority</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-sm">Hospital: Nairobi Hospital</span>
                      <span className="text-sm text-muted-foreground">2.3km away</span>
                    </div>
                  </div>
                  <div className="pt-4 border-t">
                    <div className="text-sm text-muted-foreground">Response Time</div>
                    <div className="text-2xl font-bold text-trust-green">12 minutes</div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto max-w-4xl text-center">
          <div className="space-y-6">
            <h2 className="text-3xl md:text-4xl font-bold text-balance">Ready to Transform Your Referral Process?</h2>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto text-pretty">
              Join hundreds of healthcare facilities already using MedRef to save time and improve patient outcomes.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-6">
              <Button size="lg" className="text-lg px-8" asChild>
                <Link href="/register">
      ...
      <footer id="contact" className="border-t bg-muted/30 py-16 px-4">
        <div className="container mx-auto max-w-6xl">
          <div className="grid md:grid-cols-4 gap-8">
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground text-sm">
                Connecting healthcare facilities for better patient outcomes across Kenya and beyond.
              </p>
            </div>
          ...
          <div className="border-t mt-12 pt-8 text-center text-sm text-muted-foreground">
            <p>&copy; 2024 MedRef. All rights reserved. | Privacy Policy | Terms of Service</p>
          </div>
        </div>
      </footer>
    </div>
